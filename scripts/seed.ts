...
import { hero, about, experiences, projects, contact } from "../src/lib/db/schema";
...
async function main() {
  ...
  await db.insert(hero).values({
    ...
    titleId: "AI-Powered Fullstack Engineer",
    titleEn: "AI-Powered Fullstack Engineer",
  ...
  await db.insert(about).values({
    ...
    titleEn: "About Me",
    bio1Id: "Menembus Batas Code & <br /><span className=\"text-[#2b7fff]\">Infrastruktur Server.</span>",
    bio1En: "Breaking Boundaries in Code & <br /><span className=\"text-[#2b7fff]\">Server Infrastructure.</span>",
    bio2Id: "Halo! Saya Ibnu Rizqia Ramadan, seorang <span className=\"text-[#F8FAFC] font-medium\">AI-Powered Fullstack Engineer & Infrastructure Specialist</span> yang saat ini bekerja di <a href=\"https://gothru.co\" target=\"_blank\" rel=\"noopener noreferrer\" className=\"text-[#2b7fff] hover:underline font-medium\">GoThru.co</a>. Saya berfokus pada pembangunan aplikasi web berkinerja tinggi serta pengelolaan infrastruktur server yang <span className=\"italic\">scalable</span>, memanfaatkan efisiensi kecerdasan buatan untuk mempercepat alur kerja pengembangan modern.",
    bio2En: "Hello! I'm Ibnu Rizqia Ramadan, an <span className=\"text-[#F8FAFC] font-medium\">AI-Powered Fullstack Engineer & Infrastructure Specialist</span> currently working at <a href=\"https://gothru.co\" target=\"_blank\" rel=\"noopener noreferrer\" className=\"text-[#2b7fff] hover:underline font-medium\">GoThru.co</a>. I focus on building high-performance web applications and managing scalable server infrastructure, leveraging AI efficiency to accelerate modern development workflows.",
    bio3Id: "Menjembatani celah antara rekayasa perangkat lunak dan administrasi sistem, saya mengadopsi alat bantu AI untuk mengoptimalkan seluruh siklus pemrograman. Di ranah <span className=\"italic\">software development</span>, saya terbiasa membangun sistem yang cepat dan efisien menggunakan <span className=\"text-[#F8FAFC] font-medium\">Next.js</span>, <span className=\"text-[#F8FAFC] font-medium\">Go (Fiber)</span>, <span className=\"text-[#F8FAFC] font-medium\">Bun</span>, dan <span className=\"text-[#F8FAFC] font-medium\">Drizzle ORM</span>. Sementara di sisi infrastruktur, saya memiliki keahlian dalam pengelolaan <span className=\"text-[#F8FAFC] font-medium\">bare-metal server</span>, optimalisasi lingkungan <span className=\"text-[#F8FAFC] font-medium\">Proxmox Virtual Environment</span>, hingga manajemen <span className=\"text-[#F8FAFC] font-medium\">LXC</span>.",
    bio3En: "Bridging the gap between software engineering and system administration, I adopt AI tools to optimize the entire programming lifecycle. In the realm of <span className=\"italic\">software development</span>, I am accustomed to building fast and efficient systems using <span className=\"text-[#F8FAFC] font-medium\">Next.js</span>, <span className=\"text-[#F8FAFC] font-medium\">Go (Fiber)</span>, <span className=\"text-[#F8FAFC] font-medium\">Bun</span>, and <span className=\"text-[#F8FAFC] font-medium\">Drizzle ORM</span>. Meanwhile on the infrastructure side, I have expertise in managing <span className=\"text-[#F8FAFC] font-medium\">bare-metal servers</span>, optimizing <span className=\"text-[#F8FAFC] font-medium\">Proxmox Virtual Environments</span>, and managing <span className=\"text-[#F8FAFC] font-medium\">LXC</span>.",
