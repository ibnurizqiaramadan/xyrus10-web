        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              {socialLinks.map((social) => (
                <a
                  ...
                  className="glass-card p-3 rounded-2xl md:hover:scale-110 transition-all duration-300 hover:glow-primary group active:scale-95"
                >
                  <social.icon
                    size={24}
          ...
          >
            <div className="relative w-full max-w-md mx-auto">
              <div className="absolute inset-0 bg-gradient-to-r from-[#4F46E5] to-[#22D3EE] rounded-full md:blur-3xl blur-2xl opacity-30 md:animate-pulse"></div>
